...
public class OrderCancelDisplay extends javax.swing.JFrame {
    ...
    public void setVisible(String product, ArrayList<TradableDTO> orders) {
        ...
        for (TradableDTO trd : orders) {
            ((DefaultListModel) orderList.getModel()).addElement(String.format("%4s %4d [of original %4d] @ %s [ID: %s]",
                    trd.getBuyOrSell(),
                    trd.getRemVolume(),
                    trd.getOrigVolume(),
                    trd.getOrdPrice(),
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        for (Integer selection : results) {
            ...
            try {
                marketDisplay.getUser().submitOrderCancel(t.getSymbol(), t.getBuyOrSell(), t.getId());
            } catch (Exception ex) {
